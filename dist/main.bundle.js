...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_23__services_user_service_client__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_24__services_website_service_client__["a" /* WebsiteService */], __WEBPACK_IMPORTED_MODULE_25__services_page_service_client__["a" /* PageService */], __WEBPACK_IMPORTED_MODULE_26__services_widget_service_client__["a" /* WidgetService */], __WEBPACK_IMPORTED_MODULE_31__assignment_directives_sortable_directive__["a" /* SortableDirective */]],
    ...
    PageNewComponent.prototype.createPage = function () {
        ...
        if (!this.pageName) {
            ...
            if (this.pageService.validatePageName(this.websiteID, this.pageName)) {
                var newPage = new __WEBPACK_IMPORTED_MODULE_2__page_model_client__["a" /* Page */]('', this.pageName, this.websiteID, this.pageDescription);
    ...
    WebsiteNewComponent.prototype.createWebsite = function () {
        ...
        if (!this.websiteName) {
            ...
            if (this.websiteService.validateWebsiteName(this.userID, this.websiteName)) {
                var newWebsite = new __WEBPACK_IMPORTED_MODULE_2__website_model_client__["a" /* Website */]('', this.websiteName, this.userID, this.websiteDescription);
...
var UserService = (function () {
    ...
    UserService.prototype.createUser = function (username, password) {
        ...
        var user = new __WEBPACK_IMPORTED_MODULE_2__components_user_user_model_client__["a" /* User */]('', username, password, '', '', '');
