...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_8__services_test_service_client__["a" /* TestService */], __WEBPACK_IMPORTED_MODULE_29__services_user_service_client__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_30__services_website_service_client__["a" /* WebsiteService */], __WEBPACK_IMPORTED_MODULE_31__services_page_service_client__["a" /* PageService */], __WEBPACK_IMPORTED_MODULE_32__services_widget_service_client__["a" /* WidgetService */], __WEBPACK_IMPORTED_MODULE_34__assignment_directives_sortable_directive__["a" /* SortableDirective */], __WEBPACK_IMPORTED_MODULE_33__services_flickr_service_client__["a" /* FlickrService */]],
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        this.userService.findUserByUsername(this.username)
            .subscribe(function (user) {
            _this.errorFlag = true;
            _this.errorMsg = 'Username already exists! Choose a different one!';
        }, function (error) {
            if (_this.password === _this.verifyPassword) {
                _this.userService.createUser(_this.username, _this.password)
